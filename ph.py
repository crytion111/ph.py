        ...
        # 模特 ------------------------------
            ...
            if len(args) == 2:
                ...
                try:
                    ...
                    action.send_group_text_msg(ctx.FromGroupId, "语音失败,发送文字:"+text, ctx.FromUserId)
                #action.send_group_voice_msg(ctx.FromGroupId, text, ctx.FromUserId)
